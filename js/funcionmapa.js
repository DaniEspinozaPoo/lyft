(function(w, $){
	...
	var menutoggler = '<div class="menutoggler" title="Open Push Menu"><img src="img/usuario.png" width=110px></div>' // FIxed menu Toggler HTML. Set to empty string '' to disable
